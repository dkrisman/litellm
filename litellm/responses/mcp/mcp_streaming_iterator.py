...
class MCPEnhancedStreamingIterator(BaseResponsesAPIStreamingIterator):
    ...
    def __init__(
        ...
        self.finished = False
        self._streamed_output_items: dict[int, BaseLiteLLMOpenAIResponseObject] = {}  # mutable-ok: mirrors base class attr; keyed accumulator reset per stream
        self._streamed_text_only_items: dict[int, BaseLiteLLMOpenAIResponseObject] = {}  # mutable-ok: mirrors base class attr; keyed fallback accumulator reset per stream
